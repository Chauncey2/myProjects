...
// 右侧上部柱状图
//dataAxis使用后端获取前50的城市数据
var myBarChart = echarts.init(document.getElementById('right_top'));
//视图函数传递三个值，X轴：城市名(dataAxis)  Y轴：职位数(data1)  Y轴最大值：yMax
// var result_al ={{ ringt_top_data|safe }};
...
// var pie_data ={{ right_bottom_data|safe }};
var jobType_data = pie_data[0];
var job_num_data = pie_data[1];

var myPieChart = echarts.init(document.getElementById("right_bottom"));
var pie_option = {
    title: {
        text: '不同行业所占比重',
        subtext: '纯属虚构',
